...
<body>
    ...
    <div class="container" >
        <div class="table-wrapper" id="empty">
            ...
            <div class="container" style="height:100%;overflow-x:scroll;overflow-y:hidden">
            <table class="table table-striped table-hover text-center" >
                ...
                <tbody>
                    <?php
                        $sql = "SELECT * FROM `orders` JOINS WHERE `userId`= $userId";
                      //  $sql = "select * from orders join orderitems on orders.orderId = orderitems.id WHERE userId = $userId;";

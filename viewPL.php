            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="container " data-aos="fade-right">
                           ...
                           <!--     <p class="card-text">' . substr($pizzaDesc, 0, 29). '...</p>   -->
                            ...
                            echo '</form>                            
                                <a href="viewP.php?pizzaid=' . $pizzaId . '" class="mx-2"><button class="btn btn-primary">Quick View</button></a> 
                                </div>
                            </div>
...
<!--<div class="middles">
    <div class="container-fluid my-3 alighn-items-center justify-content-center" id="cont">

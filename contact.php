...
body{
  ...
  <?php include 'partials/_nav.php';?>
      ...
      <div class="contact2" style="background-image:url(img/bgcontact.jpg);height: 400px;" id="contact">
        <div class="container">
              ...
              <div class="card card-shadow border-0 mb-4">
                <div class="row">
                  ...
                  <?php
                    ...
                    echo '<div class="col-lg-4 bg-image textcolor" style="background-color:black;url(img/map.jpg);" >
